...
add_source = """\n\nIf the question is generic then just answer with a friendly tone. Return the outcome in json format following this format: {"response": 'The answer to the question', "images": 'the relevant image urls present in a list'}."""
